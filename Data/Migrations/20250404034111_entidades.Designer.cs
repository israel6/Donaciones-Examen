...
namespace Donaciones.Data.Migrations
{
    ...
    [Migration("20250404034111_entidades")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Donaciones.Models.BeneficiarioModels", b =>
                {
                    b.Property<int>("BeneficiarioId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("BeneficiarioID");
            ...
            modelBuilder.Entity("Donaciones.Models.CampañaModels", b =>
                {
                    b.Property<int>("CampanaId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("CampanaID");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("CampanaId"));
            ...
            modelBuilder.Entity("Donaciones.Models.DonacionesModels", b =>
                {
            ...
            modelBuilder.Entity("Donaciones.Models.DonanteModels", b =>
                {
                    b.Property<int>("DonanteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<decimal>("MontoDonado")
                        .HasColumnType("decimal(18, 2)");
            ...
            modelBuilder.Entity("Donaciones.Models.DonacionesModels", b =>
                {
                    b.HasOne("Donaciones.Models.BeneficiarioModels", "Beneficiario")
                        .WithMany("Donaciones")
                        .HasForeignKey("BeneficiarioId");

                    b.HasOne("Donaciones.Models.CampañaModels", "Campana")
                        .WithMany("Donaciones")
                        .HasForeignKey("CampanaId");

                    b.HasOne("Donaciones.Models.DonanteModels", "Donante")
                        .WithMany("Donaciones")
