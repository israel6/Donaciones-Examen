...
namespace Donaciones.Areas.Identity.Pages.Account
{
 ...
 RoleManager<IdentityRole> roleManager) // Añadir este parámetro
        {
            ...
            _roles = roleManager; // Inicializar _roles
        }
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            if (_roles != null && _roles.Roles != null)
            {
                ViewData["RolesId"] = new SelectList(_roles.Roles, "Name", "Name");
            }
            else
            
                // Opción alternativa: crear una lista vacía o con un valor predeterminado
                ViewData["RolesId"] = new SelectList(new List<SelectListItem>());
                // O puedes registrar un mensaje de error en tus logs
